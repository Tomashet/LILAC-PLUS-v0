...
def build_env(
    ...
    # --------- CRITICAL WIRING FOR CALIBRATION ----------
...
def main() -> None:
    ...
    print(f"raw_context: {context}")
    print(f"canonical_context: {canonical_context}")
    ...
    debug_payload = {
        ...
        "canonical_context": list(canonical_context),
