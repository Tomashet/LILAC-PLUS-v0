...
REGIME_CONTEXTS: Dict[str, Tuple[str, str, str]] = {
    ...
    "nonstationary_unseen": ("high", "aggr", "noisy"),
}

SEEDS = [0, 1, 2]

# -----------------------------
# Thesis method taxonomy
# -----------------------------
# These ids are the clean thesis-facing method names.
# Your training code must recognize the mapped train_method ids.
# For methods not yet implemented, this script can skip them.
# -----------------------------
...
METHOD_SPECS = {
    ...
    "adjust_speed_only": {
        "stage": "B",
        "train_method": "adjust_speed_only",  # requires wiring in train_continuous.py
        "needs_threshold_patch": False,
        "implemented": False,
    ...
    "lilac_none": {
        "stage": "A",
        "train_method": "lilac_none",  # requires wiring
        "needs_threshold_patch": False,
        "implemented": False,
    ...
    "lilac_context": {
        "stage": "B",
        "train_method": "context",
        "needs_threshold_patch": True,
        "implemented": True,
        "description": "LiLAC with context-based constraints.",
    },
    "lilac_speed": {
        "stage": "B",
        "train_method": "adjust_speed",
        "needs_threshold_patch": True,
        "implemented": True,
        "description": "LiLAC with speed-adjustment constraint.",
    },
    "lilac_soft2hard": {
        "stage": "B",
        "train_method": "soft2hard",  # requires wiring
        "needs_threshold_patch": True,
        "implemented": False,
        "description": "LiLAC with soft-to-hard safety transformation only.",
    },
    "lilac_full": {
        "stage": "C",
        "train_method": "full",
    ...
    "lilac_context_speed": {
        "stage": "D",
        "train_method": "lilac_context_speed",  # requires wiring
        "needs_threshold_patch": True,
        "implemented": False,
    ...
    "lilac_context_soft2hard": {
        "stage": "D",
        "train_method": "lilac_context_soft2hard",  # requires wiring
        "needs_threshold_patch": True,
        "implemented": False,
    ...
    "lilac_speed_soft2hard": {
        "stage": "D",
        "train_method": "lilac_speed_soft2hard",  # requires wiring
        "needs_threshold_patch": True,
        "implemented": False,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run staged thesis experiments for LiLAC/LILAC+."
    )
    ...
    parser.add_argument(
        "--implemented_only",
        action="store_true",
        help="Run only methods currently marked as implemented.",
    )
...
def main() -> None:
    ...
    for method_key in method_keys:
        ...
        if args.implemented_only and not spec["implemented"]:
            continue
    ...
    for idx, (method_key, regime, seed, spec, run_dir, cmd) in enumerate(jobs, start=1):
        ...
        if not spec["implemented"]:
            print("  SKIP not yet implemented in training code.")
            skipped += 1
            continue
